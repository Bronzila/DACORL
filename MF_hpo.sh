...
RESULTS_DIR="data_mf_rseeds_arch_dropout"
ARCH_CS=--arch_cs
# ARCH_CS= 
...
then
    ...
    python train_hpo_MF.py --data_dir $RESULTS_DIR/ToySGD/$AGENT/$ID/$FC1 --output_path smac_$AGENT\_$FC1 --debug $ARCH_CS --budget $BUDGET --val_freq $VAL_FREQ

    python generate_tables.py --path $RESULTS_DIR/ToySGD --lowest --mean --results --multi_seed --num_runs $NUM_RUNS
...
then
    ...
    python train_hpo_MF.py --data_dir $RESULTS_DIR/ToySGD/$AGENT/$ID/$FC2 --output_path smac_$AGENT\_$FC2 --debug $ARCH_CS --budget $BUDGET --val_freq $VAL_FREQ
...
then
    ...
    python train_hpo_MF.py --data_dir $RESULTS_DIR/ToySGD/$AGENT/$ID/$FC3 --output_path smac_$AGENT\_$FC3 --debug $ARCH_CS --budget $BUDGET --val_freq $VAL_FREQ
...
then
    ...
    python train_hpo_MF.py --data_dir $RESULTS_DIR/ToySGD/$AGENT/$ID/$FC4 --output_path smac_$AGENT\_$FC4 --debug $ARCH_CS --budget $BUDGET --val_freq $VAL_FREQ
