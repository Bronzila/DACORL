...
then
    ...
    python train_hpo_MF.py --data_dir $RESULTS_DIR/ToySGD/$TEACHER/$ID/$FC1 --agent_type $RL_AGENT --output_path $RESULTS_DIR/smac/smac_$TEACHER\_$FC1\_$RL_AGENT --cs_type $CS_TYPE --no-tanh_scaling
...
then
    ...
    python train_hpo_MF.py --data_dir $RESULTS_DIR/ToySGD/$TEACHER/$ID/$FC2 --agent_type $RL_AGENT --output_path $RESULTS_DIR/smac/smac_$TEACHER\_$FC2\_$RL_AGENT --cs_type $CS_TYPE --no-tanh_scaling
...
then
    ...
    python train_hpo_MF.py --data_dir $RESULTS_DIR/ToySGD/$TEACHER/$ID/$FC3 --agent_type $RL_AGENT --output_path $RESULTS_DIR/smac/smac_$TEACHER\_$FC3\_$RL_AGENT --cs_type $CS_TYPE --no-tanh_scaling
...
then
    ...
    python train_hpo_MF.py --data_dir $RESULTS_DIR/ToySGD/$TEACHER/$ID/$FC4 --agent_type $RL_AGENT --output_path $RESULTS_DIR/smac/smac_$TEACHER\_$FC4\_$RL_AGENT --cs_type $CS_TYPE --no-tanh_scaling
fi
