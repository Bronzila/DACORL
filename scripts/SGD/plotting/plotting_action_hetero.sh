...
do
    ...
    python -W ignore plotting.py --data_dir $RESULTS_DIR/SGD/$teacher/ --agent $AGENT --fidelity $FIDELITY --action --num_runs $NUM_RUNS --teacher --agent_labels "$LABEL" "TD3+BC" --title "$TITLE" --heterogeneous --metric "valid_acc"
done